...
export default [
  ...
  // Aave v3 - Repay WXDAI
  ...allowErc20Approve([WXDAI], [contracts.gnosis.aaveV3.lendingPoolV3]),
  allow.gnosis.aaveV3.lendingPoolV3.repay(
    WXDAI,
    undefined,
    undefined,
    c.avatar
  ...
  // Aave v3 - Repay USDC
  ...allowErc20Approve([USDC], [contracts.gnosis.aaveV3.lendingPoolV3]),
  allow.gnosis.aaveV3.lendingPoolV3.repay(USDC, undefined, undefined, c.avatar),
  ...
  // Spark - Withdraw sDAI
  allow.gnosis.spark.lendingPoolV3.withdraw(sDAI, undefined, c.avatar),
  // Spark - Withdraw USDC
  ...
  // Spark - Repay USDC
  ...allowErc20Approve([USDC], [contracts.gnosis.spark.lendingPoolV3]),
  allow.gnosis.spark.lendingPoolV3.repay(USDC, undefined, undefined, c.avatar),
  // Spark - Repay WXDAI
  ...allowErc20Approve([WXDAI], [contracts.gnosis.spark.lendingPoolV3]),
  allow.gnosis.spark.lendingPoolV3.repay(WXDAI, undefined, undefined, c.avatar),
  // Spark - Repay XDAI
