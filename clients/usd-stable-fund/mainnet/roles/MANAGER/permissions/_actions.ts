...
export default [
  ...
  allowAction.circle_v1.bridge({ targets: ["Arbitrum"], recipient: parameters.avatar }),
  // Circle v1 - Receive USDC from Arbitrum
  allowAction.circle_v1.receive({ targets: ["Arbitrum"], sender: parameters.avatar, recipient: parameters.avatar }),

  // Circle v1 - Bridge USDC to Base
  allowAction.circle_v1.bridge({ targets: ["Base"], recipient: parameters.avatar }),
  // Circle v1 - Receive USDC from Base
  allowAction.circle_v1.receive({ targets: ["Base"], sender: parameters.avatar, recipient: parameters.avatar }),

  // Circle v1 - Bridge USDC to Optimism
  allowAction.circle_v1.bridge({ targets: ["Optimism"], recipient: parameters.avatar }),
  // Circle v1 - Receive USDC from Optimism
  allowAction.circle_v1.receive({ targets: ["Optimism"], sender: parameters.avatar, recipient: parameters.avatar }),
