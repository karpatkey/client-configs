...
import { COMP as COMP_eth, DAI as DAI_eth, USDC as USDC_eth } from "../../../../../eth-sdk/addresses"
...
export default [
  ...
  allow.arbitrumOne.gateway_router["outboundTransfer(address,address,uint256,bytes)"](
    DAI_eth,
    avatar_eth,
    undefined,
    "0x"
