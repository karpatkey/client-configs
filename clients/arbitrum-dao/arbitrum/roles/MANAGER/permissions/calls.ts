...
import { GHO, sUSDS, USDC, USDCe, USDT, compoundV3, euler, fluid } from "@/addresses/arb1"
...
export default (parameters: Parameters) =>
  [
    ...
    {
      ...allow.arbitrumOne.compoundV3.comet.supply(
        USDC
      ),
      targetAddress: compoundV3.cUsdcV3
    },
    {
      ...allow.arbitrumOne.compoundV3.comet.withdraw(
        USDC
      ),
      targetAddress: compoundV3.cUsdcV3
    },
    ...
    allow.arbitrumOne.fluid.merkleDistributor.claim(
      c.avatar,
    ),
