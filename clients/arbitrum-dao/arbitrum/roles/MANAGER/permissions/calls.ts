...
export default (parameters: Parameters) =>
  [
    ...
    allow.arbitrumOne.euler.oftAdapter.send(
      {
        ...
        // https://arbiscan.io/address/0x174834a9DE4C2f0c13c7353e62C229E8D607c808#code#F9#L91
    ...
    allowErc20Approve([syrupUSDC], [contracts.arbitrumOne.chainlink.router]),
    ...
    allowErc20Approve([USDC], [contracts.arbitrumOne.chainlink.router]),
    allow.arbitrumOne.chainlink.router.ccipSend(
      "5009297550715157269", // https://docs.chain.link/ccip/directory/mainnet/chain/mainnet
      {
        receiver: "0x" + parameters.avatar.slice(2).padStart(64, "0"),
