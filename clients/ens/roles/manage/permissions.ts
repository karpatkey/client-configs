...
import { allow as allowAction } from "defi-presets/eth";

export default [
  // Use defi-presets to generate the permissions...
  ...
  // TODO add all the other permissions (using defi-presets as much as possible)
] satisfies PresetAllowEntry[];
